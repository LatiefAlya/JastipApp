...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="Global Assets/fontawesome-free-6.5.1-web/css/all.min.css"
    />
    <link
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Spesifikasi/index.html"
                >Specification</a
              >
            </li>
            <li class="nav-item">
    ...
    <section class="container-lg py-5" id="benefits">
      <div class="row py-5 row-cols-1 row-cols-lg-3">
        <div class="feature col text-center">
          <div
            class="feature-icon d-inline-flex align-items-center justify-content-center mb-3"
          >
        ...
        <div class="feature col text-center">
          ...
          <p class="fs-5">
            Dengan garansi kamu akan lebih tenang dengan jasa jastip kami.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="container-lg my-5 text-center">
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 mx-3 mx-lg-5">
        <div class="col">
          <div
            class="card h-100"
            style="box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.1)"
          >
            <img
              src="../assets/makanan1.jpg"
              class="card-img-top"
              alt="img makanan"
            ...
            <div class="card-body">
              ...
              <h5
                ...
                style="font-size: calc(12px + 0.5vw); color: #438db8"
              >
                Rp.50.000,00
              </h5>
              <a
                href="DetailProducts/index.html"
    ...
    <section class="container-lg my-5">
      ...
      <div class="text-center my-5">
        <a href="Products/index.html" class="btn btn-outline-dark"
    ...
    <section class="container-lg text-center my-5">
      ...
      <img
        src="../assets/ic_shopee.svg"
        alt="icon shopee"
        class="mx-5 my-3 my-lg-5"
      />
      <img
        src="../assets/ic_tokped.svg"
        alt="icon tokopedia"
        class="mx-5 my-3 my-lg-5"
      />
    </section>
    ...
    <section
      class="container-lg my-5 text-center d-flex flex-column justify-content-center align-items-center"
    >
        ...
        <div class="accordion-item">
          ...
          >
            <div class="accordion-body">
              ...
              didistribusikan oleh toko terpercaya. Setiap produk yang kami jual telah
              melewati proses verifikasi keaslian produk.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          >
            <div class="accordion-body">
              Kami menerima pembayaran melalui berbagai metode, termasuk kartu
              kredit, transfer bank, dan metode pembayaran online lainnya.
              Detail pembayaran akan diberikan pada saat checkout.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            ...
            >
              <strong>Apakah ada biaya tambahan yang harus saya bayar?</strong>
            </button>
          </h2>
          <div
            id="collapseThree"
          ...
          >
            <div class="accordion-body">
              Selain harga produk, Anda mungkin dikenakan biaya pengiriman
              sesuai dengan lokasi pengiriman Anda. Biaya pengiriman akan
              diinformasikan pada saat checkout sebelum Anda menyelesaikan
              pembelian.
            </div>
          </div>
        </div>
      ...
      <div class="container-lg">
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-4 py-5 mt-5">
          ...
          <div class="col mb-3">
            ...
            <ul class="nav flex-column">
              <li class="nav-item mb-2">
                <a href="Homepage/index.html" class="nav-link p-0 text-white"
                  >Home</a
                >
              </li>
              <li class="nav-item mb-2">
              ...
              <li class="nav-item mb-2">
                <a href="#bestseller" class="nav-link p-0 text-white"
                  >Best Seller</a
                >
              </li>
              <li class="nav-item mb-2">
                <a href="Products/index.html" class="nav-link p-0 text-white"
                  >Produk Kami</a
                >
              </li>
              <li class="nav-item mb-2">
          ...
          <div class="col mb-3">
            ...
            <ul class="nav flex-column">
              <li class="nav-item mb-2">
                <a href="Contac_Us/index.html" class="nav-link p-0 text-white"
                  >Contact Us</a
                >
              </li>
              <li class="nav-item mb-2">
                <a href="about/index.html" class="nav-link p-0 text-white"
                  >About Us</a
                >
              </li>
            </ul>
          ...
          <div class="col mb-3">
            ...
            <ul class="nav flex-row">
              <li class="nav-item mb-2">
                <a href="#" class="me-2"
                  ><img src="../assets/ic_facebook.svg" alt="facebook"
                /></a>
              </li>
              <li class="nav-item mb-2">
                <a href="https://www.instagram.com/r.rzkika" class="me-2"
                  ><img src="../assets/ic_instagarm.svg" alt="facebook"
                /></a>
              </li>
              <li class="nav-item mb-2">
                <a href="#" class="me-2"
                  ><img src="../assets/ic_twitter.svg" alt="facebook"
                /></a>
              </li>
            </ul>
          </div>
